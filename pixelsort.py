...
def main():
	...
	if not preset_true:
		...
		int_func_options = ["random","threshold","edges","waves","file","file-edges","none"]
		if int_func_input in ['1','2','3','4','5','6','7']:
			int_func_input = {
				'1': 'random',
				'2': 'threshold',
				'3': 'edges',
			...
			int_rand = False
		elif int_func_input in ['8','random select']:
	...
	print("log: "+str(sys.getsizeof(pixels)))
